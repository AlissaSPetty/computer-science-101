### Circular Array - 
* _modulo_ - (represented as %) is the remainder which allows us to stay within the array 
* we use front and back markers to make sure we never go out of bounds when inserting into our array
